...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://das:darshu567@cluster0.mwgkkci.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")

DATABASE_NAME = environ.get('DATABASE_NAME', "TELEGRAM_BOT_INFO")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1001586622410'))
...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1001586622410'))
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1001586622410'))
...
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1001778805760'))
request_channel = environ.get('REQUEST_CHANNEL', '-1001586622410')
REQUEST_CHANNEL = int(request_channel) if request_channel and id_pattern.search(request_channel) else None
UPI_PAY_LOGS = int(environ.get('UPI_PAY_LOGS', '-1001586622410'))
